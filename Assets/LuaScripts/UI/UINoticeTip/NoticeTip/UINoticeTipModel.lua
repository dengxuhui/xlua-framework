...
-- 
-- @File-> Assets.LuaScripts.UI.UINoticeTip.NoticeTip.UINoticeTipModel
-- @require-> local UINoticeTipModel = require "UI.UINoticeTip.NoticeTip.UINoticeTipModel"
...
local function OnCreate(self)
	base.OnCreate(self)
	-- 保持Model
	UIManager:I():SetKeepModel(self.__ui_name, true)
	-- cs单例对象
