...
-- 
-- @File-> Assets.LuaScripts.UI.UILogin.LoginServer.UILoginServerModel
-- @require-> local UILoginServerModel = require "UI.UILogin.LoginServer.UILoginServerModel"
...
local function OnRefresh(self)
	local server_data = ServerData:I()
	...
	self.selected_server_id = ClientData:I().login_server_id
end
