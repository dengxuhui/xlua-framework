...
-- 加载界面
-- @File-> Assets.LuaScripts.UI.UILoading.Loading.UILoadingView
-- @require-> local UILoadingView = require "UI.UILoading.Loading.UILoadingView"
...
local function OnCreate(self)
	...
	self.timer = TimerManager:I():GetTimer(1, self.timer_action , self)
	self.timer:Start()
end
