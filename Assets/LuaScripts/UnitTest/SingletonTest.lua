...
local function TestSingleton()
	...
	local inst1 = testSingleton1:I()
	assert(testSingleton1.Instance == inst1)
	assert(testSingleton2.Instance == nil)
	local inst2 = testSingleton2:I()
	assert(testSingleton1.Instance == inst1)
	...
	assert(testSingleton1:I().testVar1 == 111)
	assert(testSingleton2:I().testVar1 == 222)
	inst1:Delete()
	inst1 = nil --这里一定要置空，所以不建议这么用，单例类建议都使用“类名:I().XXX”方式使用
	assert(testSingleton1.Instance == nil)
	testSingleton2:I():Delete()
	inst2 = nil --同上
	assert(testSingleton2.Instance == nil)
end
...
local function TestSingleton2()
	...
	assert(testSingleton2.Instance == nil)
	assert(testSingleton1.Instance ~= nil)
	testSingleton1:I():Delete()
	inst1 = nil --同上
	assert(testSingleton1.Instance == nil)
	inst1 = testSingleton1:I()
	inst2 = testSingleton2:I()
	testSingleton2:I():Delete()
	inst2 = nil --同上
	assert(testSingleton2.Instance == nil)
	assert(testSingleton1.Instance ~= nil)
