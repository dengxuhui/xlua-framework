...
local function OnComplete(self)
	...
	-- 创建角色
	local chara = GameObjectPool:I():GetGameObjectAsync(chara_res_path, function(inst)
		if IsNull(inst) then
		...
		UIManager:I():OpenWindow(UIWindowNames.UIBattleMain)
...
local function OnLeave(self)
	self.charaAnim = nil
	UIManager:I():CloseWindow(UIWindowNames.UIBattleMain)
	base.OnLeave(self)
end
