...
local function OnCreate(self, layer)
	...
	self.unity_canvas.worldCamera = UIManager:I().UICamera
	...
	self.unity_canvas_scaler.referenceResolution = UIManager:I().Resolution
...
local function PopWindowOrder(self)
	...
	self.top_window_order = self.top_window_order + UIManager:I().MaxOrderPerWindow
	return cur
end
